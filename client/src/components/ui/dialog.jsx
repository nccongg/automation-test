...
function DialogContent({
  ...
  // Animated AI gradient border (matches AiAnalysisSection). `aiBorderActive`
  // spins it fast — pass it your generating/loading state.
  aiBorder = false,
  aiBorderActive = false,
  ...props
}) {
  if (aiBorder) {
    const borderCls = aiBorderActive ? "ai-border-active" : "ai-border-idle";
    return (
      <DialogPortal data-slot="dialog-portal">
        ...
        <DialogPrimitive.Content
          ...
          {/* card content */}
          <div className="relative grid gap-4 rounded-xl bg-background p-6">
            {children}
